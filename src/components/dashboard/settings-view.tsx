      ...
      <div className="flex-1 overflow-auto p-6 space-y-6">
          ...
          <CardContent className="space-y-4">
            {userProfile && (
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  <Label>Email</Label>
                  <Input value={userProfile.email || 'Não informado'} disabled />
                </div>
                <div>
                  <Label>Data de Expiração</Label>
                  <Input
                    value={new Date(userProfile.expDate).toLocaleDateString('pt-BR')}
                    disabled
                  />
                </div>
                <div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleSettingChange('alwaysOnTop', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleSettingChange('startWithSystem', checked)}
              />
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Gerenciar cache e dados locais
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
        ...
        <Card className="border-red-200 dark:border-red-800">
          ...
          <CardContent>
            <Alert className="mb-4">
              <AlertDescription>
                Fazer logout irá remover todas as configurações e dados locais.
              </AlertDescription>
            </Alert>
